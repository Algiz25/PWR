...
#find closest
                closest = min(available, key=lambda req: req.deadline_time - self.curr_time)
    ...
    def print_results(self):
        ...
        plt.title("Ruch głowicy - Earliest Deadline First", fontsize=14).set_color(color='white')
